...
namespace NexFx.Presentations
{
    ...
    /// </summary>
    [ToolboxItem(true)]
    public class ExCheckBox : CheckBox, IExControl
    {
        /// <summary>
        /// キーとなる文字列を設定・取得します。
        /// </summary>
        ...
        {
            // 自身のインスタンスをサービスに渡します。
            var ecs = new Services.ExControlService<ExCheckBox>(this);
            var eccs = new Services.ExControlCoreService<ExCheckBox>(this);
